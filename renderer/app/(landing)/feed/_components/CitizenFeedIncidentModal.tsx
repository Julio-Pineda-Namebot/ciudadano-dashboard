...
export function CitizenFeedIncidentModal({
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent
        showCloseButton
        className="w-[calc(100vw-2rem)] max-w-lg gap-0 border-white/10 bg-[#0b0f1c] p-0 text-white"
      >
        ...
        {loading || !detail ? (
          ...
          <div className="max-h-[70vh] overflow-y-auto px-6 pb-6">
            ...
            <p className="mt-3 text-sm leading-relaxed text-white/90">{detail.description}</p>
            ...
            <div className="mt-5">
              ...
              <div className="mt-2 flex flex-col gap-2">
                ...
                {comments.map((c) => (
                  <div key={c.id} className="rounded-lg border border-white/10 bg-white/[0.03] p-2.5">
              ...
              <div className="mt-3 flex flex-col gap-2">
                <textarea
                  ...
                  className="w-full resize-none rounded-lg border border-white/12 bg-white/[0.03] px-3 py-2 text-sm text-white placeholder:text-white/35 focus:border-white/25 focus:outline-none"
                />
                <Button
                  type="button"
