...
export type ModuleColor = 'blue' | 'orange' | 'green' | 'yellow'
...
export const MODULE_HEADER_CLASS: Record<ModuleColor, string> = {
  ...
  yellow: 'bg-[#f0be26] text-white [&_th]:text-white [&_th]:border-[#f0be26]/30',
}
...
export const MODULE_BUTTON_CLASS: Record<ModuleColor, string> = {
  ...
  yellow: 'bg-[#f0be26] hover:bg-[#f0be26]/90 text-white',
}
